...
train_dataset = ds.MnistDataset(dataset_dir='../datasets/MNIST_Data/train', num_shards=rank_size, shard_id=rank_id)
test_dataset = ds.MnistDataset(dataset_dir='../datasets/MNIST_Data/test', num_shards=rank_size, shard_id=rank_id)
